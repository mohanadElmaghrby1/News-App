...
public class FashionActivity extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<ArrayList<News>> {

    //progress dialog
    private ProgressDialog pDialog;

    /*the news business url*/
    private String FASHION_NEWS_URL="http://content.guardianapis.com/search?q=fashion&api-key=test";
    ...
    public Loader<ArrayList<News>> onCreateLoader(int id, Bundle args) {
        pDialog = new ProgressDialog(FashionActivity.this);
        pDialog.setMessage("Loading..");
        pDialog.setIndeterminate(true);
        pDialog.setCancelable(false);
        pDialog.show();

        return new NewsLoader(this,FASHION_NEWS_URL);
    }
