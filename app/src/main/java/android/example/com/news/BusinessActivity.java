...
public class BusinessActivity extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<ArrayList<News>> {

    //progress dialog
    private ProgressDialog pDialog;

    /*the news business url*/
    private String BUSINESS_NEWS_URL="http://content.guardianapis.com/search?q=business&api-key=test";
    ...
    public Loader<ArrayList<News>> onCreateLoader(int id, Bundle args) {
        ...
        return new NewsLoader(this,BUSINESS_NEWS_URL);
    }
