...
public class PoliticsActivity extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<ArrayList<News>> {

    //progress dialog
    private ProgressDialog pDialog;

    /*the news business url*/
    private String POLITICS_NEWS_URL="http://content.guardianapis.com/search?q=politics&api-key=test";
    ...
    public Loader<ArrayList<News>> onCreateLoader(int id, Bundle args) {
        pDialog = new ProgressDialog(PoliticsActivity.this);
        pDialog.setMessage("Loading..");
        pDialog.setIndeterminate(true);
        pDialog.setCancelable(false);
        pDialog.show();

        return new NewsLoader(this,POLITICS_NEWS_URL);
    }
